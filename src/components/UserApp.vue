  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <select v-model="selectedRole" class="custom-select" id="selectRole">
      ...
      <div class="col-md-6">
        ...
        <select v-model="selectedPlan" class="custom-select" id="selectPlan">
          <option value="All">All</option>
        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr v-for="user in sliceFilterUsers" :key="user.id">
                  <th>
                    <div>
          ...
          <div class="card-footer d-flex justify-content-between">
            <!-- page length count-->
            <span>
              Showing {{ sliceFilterUsers.length > 0 ? 1:0 }} to {{ sliceFilterUsers.length }} of
